...
class Customer
{
    ...
    public function getDefaultAddressArray()
    {
        if (!is_null($this->defaultAddress)) {
            return [
                "id" => $this->defaultAddress->getId(),
                "customerId" => $this->defaultAddress->getCustomerId(),
                "firstName" => $this->defaultAddress->getFirstName(),
                "lastName" => $this->defaultAddress->getLastName(),
                "company" => $this->defaultAddress->getCompany(),
                "address1" => $this->defaultAddress->getAddress1(),
                "address2" => $this->defaultAddress->getAddress2(),
                "city" => $this->defaultAddress->getCity(),
                "province" => $this->defaultAddress->getProvince(),
                "country" => $this->defaultAddress->getCountry(),
                "zip" => $this->defaultAddress->getZip(),
                "phone" => $this->defaultAddress->getPhone(),
                "name" => $this->defaultAddress->getName(),
                "provinceCode" => $this->defaultAddress->getProvinceCode(),
                "countryCode" => $this->defaultAddress->getCountryCode(),
                "countryName" => $this->defaultAddress->getCountryName(),
                "default" => $this->defaultAddress->isDefault(),
            ];
        }
